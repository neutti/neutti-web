...
public class BrowserDetect
{
    ...
    {
        if (atLeast(request, UserAgentXX.IE, 8))
        {
            return 6;
        }
        else if (atLeast(request, UserAgentXX.AppleWebKit, 8))
        {
            return 4;
        }
        else if (atLeast(request, UserAgentXX.Opera, 9))
        {
            return 4;
        }
        else
     ...
     */
    public static boolean atLeast(HttpServletRequest request, UserAgentXX requiredUserAgent)
    {
     ...
     * @return true iff the browser matches the spec.
     */
    public static boolean atLeast(HttpServletRequest request, UserAgentXX requiredUserAgent, int requiredVersion)
    {
        String userAgent = request.getHeader("user-agent");
        int realVersion;
    ...
    /**
     * Check {@link #atLeast(HttpServletRequest, UserAgentXX)} for
     * {@link UserAgentXX#AppleWebKit}
     */
